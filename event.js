...
Complexity Analysis:
Time complexity: For subscribe: 
�
(
1
)
O(1) & For unsubscribe and emit: 
�
(
�
)
O(n) , where n represents the number of callbacks subscribed to the event
Space complexity: 
�
(
�
...
Complexity Analysis:
Time complexity: For subscribe & unsubscribe: 
�
(
1
)
