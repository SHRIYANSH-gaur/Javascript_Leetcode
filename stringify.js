...
Funfact: Switch case statment have fallthrough mechanism in them. you can read them more in this Wikipedia article
...
Intuition:
We can use a ternary operator to do the same thing that we can do with if-else and switch case statments.
...
What are some potential challenges or edge cases to consider when converting an object to a JSON string representation? Some challenges and edge cases to consider include:
